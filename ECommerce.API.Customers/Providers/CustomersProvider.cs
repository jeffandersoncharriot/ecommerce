    ...
    public class CustomersProvider : ICustomersProvider
    {
        ...
        private void SeedData()
        {
            if (!dbContext.Customers.Any())
            {
                ...
                dbContext.Customers.Add(new Db.Customer() { Id = 1, Name = "Jessica Smith", Address = "20 Elmest St." });
                dbContext.Customers.Add(new Db.Customer() { Id = 2, Name = "John Smith", Address = "30 Main Street." });
